  ...
  background-color: #316b83;
    ...
    <body>
		...
		<nav class="navbar navbar-custom navbar-expand-lg navbar-dark bg-primary">
          <a class="navbar-brand text-light" href="index.php"><h4>SS Flight Booking</h4></a>
        ...
        <a class="navbar-brand" href="../index.php"><h5>SS Flight Booking</h5>            
        </a>
        <button class="navbar-toggler" type="button" data-toggle="collapse"
            data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
            aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
                ...
                <div class="dropdown-menu w-75" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item " href="login.php">Administrator</a>
                </div>
                </div>';
            }
			?>
